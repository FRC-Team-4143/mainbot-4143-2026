...
public class Baymax_Destroy_Same_Side_Left extends Auto {

    public Baymax_Destroy_Same_Side_Left() {
        // =============================================================================
        // TRAJECTORY LOADING
        // These should be loaded in the order they will be used to ensure correct start poses
        // =============================================================================
        loadTrajectory(ChoreoTraj.BaymaxDestroySameSideLeft.name());
        ...
        addCommands(
                ...
                SwerveSubsystem.getInstance()
                        .setDesiredChoreoTrajectoryCommand(
                                getTrajectory(ChoreoTraj.BaymaxDestroySameSideLeft.name())),
