...
public class Citrus_Left_Side_Trench extends Auto {

    public Citrus_Left_Side_Trench() {
        // =============================================================================
        // TRAJECTORY LOADING
        // These should be loaded in the order they will be used to ensure correct start
        // poses
        // =============================================================================
        loadTrajectory(ChoreoTraj.CitrusLeftSideTrench.name());
        loadTrajectory(ChoreoTraj.CitrusLeftSideSecondPassTrench.name());
        loadTrajectory(ChoreoTraj.CitrusLeftSideSecondPassBumpTrench.name());
        ...
        addCommands(
                ...
                SwerveSubsystem.getInstance()
                        .setDesiredChoreoTrajectoryCommand(
                                getTrajectory(ChoreoTraj.CitrusLeftSideTrench.name())),
                ...
                new ConditionalCommand(
                        SwerveSubsystem.getInstance()
                                .setDesiredChoreoTrajectoryCommand(
                                        getTrajectory(ChoreoTraj.CitrusLeftSideSecondPassTrench.name())),
                        SwerveSubsystem.getInstance()
                                .setDesiredChoreoTrajectoryCommand(
                                        getTrajectory(
                                                ChoreoTraj.CitrusLeftSideSecondPassBumpTrench.name())),
