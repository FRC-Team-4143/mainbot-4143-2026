...
public class Left_Bump_Bump_Swipe extends Auto {

    public Left_Bump_Bump_Swipe() {
        // =============================================================================
        // TRAJECTORY LOADING
        // These should be loaded in the order they will be used to ensure correct start
        // poses
        // =============================================================================
        loadTrajectory(ChoreoTraj.LBumpStartBumpReturn.name());
        loadTrajectory(ChoreoTraj.LBumpSwipeBumpReturn.name());
        ...
        addCommands(
                ...
                SwerveSubsystem.getInstance()
                        .setDesiredChoreoTrajectoryCommand(
                                getTrajectory(ChoreoTraj.LBumpStartBumpReturn.name())),
                ...
                SwerveSubsystem.getInstance()
                        .setDesiredChoreoTrajectoryCommand(
                                getTrajectory(ChoreoTraj.LBumpSwipeBumpReturn.name())),
                // Start Choreo following
                Commands.startEnd(
                                () ->
                                        SwerveSubsystem.getInstance()
