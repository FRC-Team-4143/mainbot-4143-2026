...
public class Left_Trench_Depot_Climb extends Auto {

    public Left_Trench_Depot_Climb() {
        // Register trajectories first
        // These should be loaded in the order they will be used to ensure correct start poses
        loadTrajectory(ChoreoTraj.LeftTrenchDepot.name());
        ...
        addCommands(
                ...
                SwerveSubsystem.getInstance()
                        .setDesiredChoreoTrajectoryCommand(
                                getTrajectory(ChoreoTraj.LeftTrenchDepot.name())),
