...
public class Right_Trench_Bump_Swipe extends Auto {

    public Right_Trench_Bump_Swipe() {
        // =============================================================================
        // TRAJECTORY LOADING
        // These should be loaded in the order they will be used to ensure correct start poses
        // =============================================================================
        loadTrajectory(ChoreoTraj.RTrenchStartBumpReturn.name());
        loadTrajectory(ChoreoTraj.RTrenchSwipeBumpReturn.name());
        ...
        addCommands(
                ...
                SwerveSubsystem.getInstance()
                        .setDesiredChoreoTrajectoryCommand(
                                getTrajectory(ChoreoTraj.RTrenchStartBumpReturn.name())),
