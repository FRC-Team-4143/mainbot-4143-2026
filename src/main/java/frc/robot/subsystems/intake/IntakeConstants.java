...
public class IntakeConstants extends MwConstants {
    ...
    // Intake Configs
    public final int INTAKEMOTOR_ID = 30; // Place holder
    ...
    // Arm Configs
    public final int ARMMOTOR_ID = 31; // Place holder
    ...
    public IntakeConstants() {
        ...
        INTAKE_MOTOR_CONFIG.config.MotorOutput.Inverted = PhoenixUtil.toInvertedValue(INTAKEMOTOR_INVERTED);
